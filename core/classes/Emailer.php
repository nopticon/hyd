...
class emailer {
    ...
    public function send() {
        ...
        $cc = isset($this->addresses['cc']) ? implode(', ', $this->addresses['cc']) : '';
    ...
    //
    public function attachFile($filename, $szFromAddress, $szFilenameToDisplay, $mimetype = 0) {
        global $lang;
        ...
        $this->msg = sprintf($format, $mime_boundary, $lang['ENCODING'], $this->msg);
