...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
	...
	<tr>
		<td class="row2"><?php if(!empty($row_item['url'])) { ?><input type="checkbox" name="{row.var}checked" checked="checked" /><?php }else echo '<input type="hidden" name="', $row_item['var'], 'checked" value="0" />'; ?></td>
		<td class="row1" width="100%"><span class="gen">{row.name}</span></td>
	...
	<tr>
		<td class="catBottom" colspan="4" align="center">{S_HIDDEN_FIELDS}<input type="submit" name="submit" value="{L_XS_CONTIUNE}" class="bold" /></td>
	</tr>
</table>
</form>
