...
if ( $lang_extend_admin )
{
	...
	$lang['PCP_tableslinked_join_explain'] = 'FROM statement used in SQL requests.<hr />&raquo;&nbsp;Use [cst.<i>table constant</i>] to get back the real table name.<br />(ie : [cst.MEMBERS_TABLE] for phpbb_users).<hr />&raquo;&nbsp;Use [<i>Tables linked name</i>] to identify the SQL id.<br />(ie: [USERS].username)<hr />Example: [cst.MEMBERS_TABLE] AS [USERS]';
