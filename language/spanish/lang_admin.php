 ...
 *
 *     $Id: lang_admin.php,v 1.1.1.1 2006/01/06 03:36:47 Psychopsia Exp $
 *
 ****************************************************************************/
...
$lang['Not_admin'] = "No estas autorizado para administrar Rock Republik";
$lang['Welcome_phpBB'] = "Bienvenido a phpBB";
$lang['Admin_intro'] = "Gracias por elegir phpBB como su solución para su foro. Esta pantalla le dar&aacute; una síntesis de las principales estadísticas de su foro. Puede regresar a esta p&aacute;gina clickeando en el link de <u>Indice del Administrador</u> en el panel de la izquierda. Para regresar al índice de su foto, clickee el logo de phpBB también ubicado en el panel izquierdo. Los otros links ubicados a la izquierda de esta pantalla le permitir&aacute;n controlar todos los aspectos de este foro, cada pantalla tendr&aacute; instrucciones de como utilizar las herramientas.";
$lang['Main_index'] = "Foro de Discusión";
...
$lang['Avatar_dir_size'] = "Tamaño del directorio de Im&aacute;genes";
...
$lang['Backup'] = "Backup";
$lang['Restore_explain'] = "Esto restaurar&aacute; todas las tablas de phpBB desde un archivo previamente guardado. Si su servidor lo soporta usted puede subir un archivo de texto comprimido mediante el gzip y éste sera automaticamente descomprimido automaticamente. <b>ATENCION</b> Esto sobre-escribir&aacute; la información existente. La restauración puede durar unos minutos, por favor quédese en esta p&aacute;gina hasta que el proceso se haya completado.";
...
$lang['Group_auth_explain'] = "Desde aquí podr&aacute; cambiar los permisos y el estado del moderador asignado a cada grupo de usuarios. Recuerde que cambiando los permisos del Grupo, que los permisos individuales cambiar&aacute;n una vez que la persona ingrese al foro. Usted ser&aacute; advertido en este caso.";
$lang['User_auth_explain'] = "Desde aquí usted puede cambiar los permisos y estado del moderador asignado a cada usuario. Tenga presente que cambiando los permisos de un usuario los permisos del grupo permaneceran sin cambiar hasta que el usuario entre a los foros. Usted ser&aacute; advertido en este caso.";
$lang['Forum_auth_explain'] = "Desde aquí puede cambiar los niveles de autorización de cada foro. Para realizar esto tiene dos modos; uno simple y otro avanzado. Este último le brindar&aacute; mayor control para la operación y el funcionamiento de cada foro. Tenga en cuenta que al cambiar los niveles de cada foro puede afectar el funcionamiento de cada usuario según el foro y los permisos que tenga el usuario.";
...
$lang['Conflict_access_userauth'] = "Este usuario aún posee acceso a este foro debido al Grupo al cual pertenece. Usted deber&aacute; cambiar los permisos del grupo o borrar al usuario del Grupo para preveer que el usuario no tenga acceso a este foro. Los derechos del Grupo y el Usuario se explican abajo.";
$lang['Conflict_mod_userauth'] = "Este usuario todavía posee derechos de Moderador a través de un Grupo al cual pertence. Usted deber&aacute; cambiar los permisos del grupo o borrar al usuario de dicho Grupo para estar seguro que este usuario no tenga acceso al foro con permisos de Moderar. Los derechos se explican abajo.";

$lang['Conflict_access_groupauth'] = "El siguiente usuario (o usuarios) todavía tiene acceso a este foro debido a los permisos que tiene como Usuario. Para que no tenga acceso a este foro usted deber&aacute; cambiar sus permisos. Los derechos de Usuarios se explican abajo.";
$lang['Conflict_mod_groupauth'] = "El siguiente usuario (o usuarios) todavía posee derechos de Moderador en este foro. Para que no tenga acceso a este foro usted deber&aacute; cambiar sus permisos de usuario. Los derechos de Usuarios se explican abajo.";
...
$lang['Group_memberships'] = 'Grupo de Usuarios (en total: %d)';
//$lang['Usergroup_members'] = "Este Grupo contiene los siguientes Usuarios";
$lang['Usergroup_members'] = 'Este Grupo contiene los siguientes Usuarios (en total: %d)';
...
$lang['Ban_explain'] = "Desde aquí usted puede banear a un usuario. Puede banear a los usuarios por su nombre, por su dirección IP, o por su Hostname. Este método previene que un usuario tenga acceso a la p&aacute;gina principal del foro. Para prevenir que el Usuario se registre con una nueva cuenta también puede bannear su dirección de email. Tenga en cuenta que baneando una dirección de email no evitar&aacute; que el usuario pueda ingresar al foro ni que publique mensajes. Para realizar eso deber&aacute; utilizar uno de los dos métodos explicados anteriormente.";
...
$lang['Ban_IP_explain'] = "Para especificar diferentes IPs o Nombres de Dominio, sep&aacute;relos con comas. Para especificar un rango de direcciones IP separe el comienzo y el final utilizando un guión (-), para especificar un comodín utilize el *";

$lang['Ban_email'] = "Banear una o varias direcciones de email";
$lang['Ban_email_explain'] = "Para especificar m&aacute;s de un email, colóquelos separados por comas. Para especificar un comodín de usarios utilece *, por ejemplo *@hotmail.com";
...
$lang['Config_explain'] = "El siguiente formulario, le permitir&aacute; cambiar las opciones de su foro. Para la configuración de Usuarios y Foros use los enlaces de la izquierda.";
...
$lang['Abilities_settings'] = "Configuración B&aacute;sica de Usuario y del Foro";
$lang['Max_poll_options'] = "Número m&aacute;ximo de items en Encuentas";
...
$lang['Override_style_explain'] = "Se utilizar&aacute; el estilo seleccionado por defecto sin importar la elección del usuario";
...
$lang['Max_sig_length'] = "M&aacute;xima longitud de la Firma";
...
$lang['Allow_quick_reply'] = 'Permitir Respuesta R&aacute;pida';
...
$lang['Max_filesize'] = "Tamaño m&aacute;ximo para las im&aacute;genes";
$lang['Max_filesize_explain'] = "Limita la cantidad de bytes que puede tener un Avatar";
$lang['Max_avatar_size'] = "M&aacute;ximo Tamaño del Avatar";
...
$lang['Email_sig_explain'] = "Este texto se añadir&aacute; al final de cada email";
...
$lang['Cookie_settings_explain'] = "Esto controla como se envían las cookies al Navegador, en la mayoría de los casos la configuración preestablecida sera m&aacute;s que suficiente. Si necesita cambiar esto tenga cuidado, ya que en caso de configurarlo mal podría hacer que sus Usuarios no puedan Ingresar al Foro";
...
$lang['Cookie_secure_explain'] = "Si su servidor est&aacute; corriendo via SSL marque esta opción de otra manera déjelo deshabilitado";
...
$lang['Forum_edit_delete_explain'] = "El siguiente formulario le permitir&aacute; personalizar las opciones del Foro. Para la configuración de usuarios y Foros utilice los enlaces de la izquierda.";

$lang['Move_contents'] = "Mover todos los contenidos";
$lang['Forum_delete'] = "Borrar el Foro";
$lang['Forum_delete_explain'] = "El siguiente formulario le permitir&aacute; Borrar algún foro (o categoría) y decir donde desea colocar todos los Tópicos y Categorías.";
...
$lang['smile_desc'] = "Desde esta p&aacute;gina usted puede añadir, quitar o editar algún emoticon para que los Usuarios utilicen en el foro y en los mensajes Privados";
...
$lang['export_smiles'] = "Para crear un paquete de Smiles de sus smileys instalados, presione %sAquí%s para bajar el archivo smiles.pak. Nombre este archivo de forma apropiada pero asegúrese de mantener la extension .pak. Luego cree un archivo zip que contenga todos los smileys m&aacute;s el archivo .pak.";
...
$lang['User_delete_explain'] = "Presione aquí para borrar este Usuario. Tenga en cuenta que luego no podr&aacute; restaurarlo.";
...
$lang['User_special_explain'] = "Estos campos no est&aacute;n disponibles para que los Usuarios lo modifiquen. Desde aquí usted puede configurar el status y otras opciones que los Usuarios no pueden modificar.";
...
// Mass Email
//
$lang['Mass_email_explain'] = "Desde aquí usted puede enviar mensajes de email a todos sus Usuarios y Grupos. Al hacer esto un email ser&aacute; enviado desde el email administrativo inidicado previamente. Si envía este email a un Grupo numeroso por favor sea paciente y espere a que termine de cargar la p&aacute;gina. Es normal que tarde unos cuantos minutos, usted sera notificado una vez finalizado el envío.";
...
$lang['Rank_maximum'] = "M&aacute;xima cantidad de Mensajes";
...
$lang['Styles_explain'] = "Desde aquí usted puede f&aacute;cilmente añadir, quitar y administrar los estilos (plantillas y temas) disponibles para sus usuarios";
$lang['Styles_addnew_explain'] = "La siguiente lista contiene todos los temas que est&aacute;n disponibles para las plantillas. Los items de la lista no han sido instalados en la base de los foros phpBB. Para hacer eso simplemente haga clic en el enlace que figura al lado de cada opción";
...
$lang['Create_theme_explain'] = "Utilice el siguiente formulario para crear un tema nuevo para la plantilla seleccionada. Cuando ingrese los colores (los cuales debe ingresar de forma hexadecimal) no debe incluir el # . Ejemplo: CCCCCC es v&aacute;lido, no asi lo seria colocar #CCCCCC";

$lang['Export_themes'] = "Exportar Tema";
$lang['Export_explain'] = "Desde este panel usted podra exportar el tema para la plantilla seleccionada. Seleccione la plantilla de la lista debajo y el programa crear&aacute; el archivo de configuración del tema y asi podra guardarlo. Si no se puede grabar el archivo se le brindara a usted la oportunidad de Descargarlo. Para que el programa pueda guardarlo usted debe dar permiso de escritura a la carpeta de plantillas (template). Para mas información utilize la guia del foro phpBB 2";
...
$lang['Confirm_delete_style'] = "Est&aacute; seguro que desea borrar este estilo";
...
$lang['Style_exists'] = "El nombre de estilo seleccionado ya existe, por favor vuelva atr&aacute;s y seleccione otro distinto";
...
$lang['Re_install'] = "Su instalación previa todavía se encuentra activa. <br /><br />Si desea reinstlar los foros phpBB 2 presione Si en el boton debajo. Por favor tenga en cuenta que al realizar esto se destruir&aacute; la información existente, no se har&aacute;n copias de seguridad. El usuario administrador y la contraseña que usted usaba anteriormente ser&aacute;n creados nuevamente, m&aacute;s no otro tipo de información <br /><br />¡Piense cuidadosamente &aacute;ntes de presionar SI!";

$lang['Inst_Step_0'] = "Gracias por elegir phpBB 2. Para finalizar la instalación por favor complete los datos requeridos debajo. Tenga en cuenta que la Base de Datos destinada a los foros ya debería existir. Si est&aacute; instalando en una Base de Datos que utiliza OBDC, por ejemplo MS Access primero deber&aacute; crear un DNS y después continuar.";
...
$lang['Inst_Step_2'] = "Su usuario administrador y contraseña han sido creados. En este punto el proceso de Instalación B&aacute;sica ha sido completado. Ahora ser&aacute; enviado una pantalla que le permitir&aacute; administrar la nueva instalación. Por favor asegurece de verificar la Configuración General y de haber realizado los cambios requeridos. Gracias por escoger phpBB 2";

$lang['Unwriteable_config'] = "Su archivo de configuración esta en un modo de no-escritura. Una copia del archivo de configuración podr&aacute; ser descargada cuando presione el botón siguiente. Usted debe subir este fichero en el mismo directorio donde se encuentre el foro phpBB 2. Una vez que esto se haya realizado debe ingresar usando el usuario de administrador y contraseña que usted escogio en el formulario anterior y así visitar el Control de Administración para ver la configuración general. Gracias por escoger phpBB 2";
$lang['Download_config'] = "Descargar Configuración";

$lang['ftp_choose'] = "Escoger Método de Descarga";
$lang['ftp_option'] = "<br />Ya que las extensiones FTP est&aacute;n disponibles en esta versión de PHP usted podr&aacute; escoger si quiere, mediante FTP, colocar el archivo en su lugar autom&aacute;ticamente.";
$lang['ftp_instructs'] = "Usted ha seleccionado subir autom&aacute;ticamente por ftp el archivo en la cuenta que contiene el phpBB 2. Por favor ingrese la información solicitada para facilitar el proceso. Tenga en cuenta que la ruta FTP debe ser la ruta exacta al PHPBB 2 como si fuera a subir los archivos usando cualquier cliente de ftp.";
$lang['ftp_info'] = "Ingrese la Información de su FTP";
$lang['Attempt_ftp'] = "Intentar subir archivo mediante ftp en forma autom&aacute;tica";
...
$lang['NoFTP_config'] = "El intento se subir por ftp el archivo de configuración ha fallado. Por favor desc&aacute;rgue el archivo de configuración y súbalo por FTP en forma manual.";
...
$lang['Registration_IP'] = 'Dirección IP de registro';
...
$lang['Hidde_last_logon'] = "Ocultar hora de última visita"; 
$lang['Hidde_last_logon_expain'] = "Si se selecciona SI, la hora de la últma visita de usuarios, estar&aacute; oculta para los usuarios excepto para Administradores"; 
